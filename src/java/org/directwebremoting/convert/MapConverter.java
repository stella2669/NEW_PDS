    ...
    public Object convertInbound(Class<?> paramType, InboundVariable data) throws ConversionException
    {
        ...
        try
        {
            ...
            for (int i = 0; i < size; i++)
            {
                ...
                valIv.dereference();
                if ("string".equals(valIv.getType())) {
                	valType = String.class;
                } else if ("number".equals(valIv.getType())) {
                	if (valIv.getValue() != null && valIv.getValue().indexOf(".") > -1) {
                		valType = float.class;
                	} else {
                		valType = int.class;
                	}
                }
                Object val = converterManager.convertInbound(java.lang.String.class, valIv, valProp);

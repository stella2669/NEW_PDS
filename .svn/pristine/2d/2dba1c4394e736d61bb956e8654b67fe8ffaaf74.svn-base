    ...
    $.extend( $.jqx._jqxDataTable.prototype, {
        ...
        _arrangeAutoWidth: function ( scrollOffset ) {
            ...
            if ( this.width === "auto" || this.width === null || this.autowidth ) {
                ...
                for ( var i = 0; i < this.columns.records.length; i++ ) {
                    ...
                    if ( cw == 'auto' ) {
                        cw = this._measureElementWidth( this.escape_HTML( this.columns.records[ i ].text ) );
                        w += cw;
                    }
                    else {
                        w += cw;
        ...
        _updatecolumnwidths: function () {
            ...
            $.each( this.columns.records, function ( i, value ) {
                ...
                if ( this.width != 'auto' && !this._width && !percentage ) {
                    ...
                    if ( width < 0 ) {
                        var $element = $( '<span>' + that.escape_HTML( this.text ) + '</span>' );
        ...
        _rendercolumnheaders: function () {
            ...
            $.each( this.columns.records, function ( i, value ) {
                ...
                var columnContent = this.renderer != null ? this.renderer( that.escape_HTML( this.text ), this.align, headerheight ) : that._rendercolumnheader( that.escape_HTML( this.text ), this.align, headerheight, that );
                if ( columnContent == null ) {
                    columnContent = that._rendercolumnheader( that.escape_HTML( this.text ), this.align, headerheight, that );
                }

...
@Mapper
public interface USAU02_Mapper {
	 ...
	 * @return
	 */
	public void insertProgDefaultAuth(Map<String, Object> paramMap);
	 ...
	 * @return
	 */
	public void deleteProgDefaultAuth(Map<String, Object> paramMap);
	...
	public List<Map<String, Object>> getThisAuthUser(Map<String, Object> paramMap);
	public List<Map<String, Object>> getThisAuthProg(Map<String, Object> paramMap);
	public void chAuthProgAdd(Map<String, Object> paramMap);
}

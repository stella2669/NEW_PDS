    ...
    $.extend($.jqx._jqxWindow.prototype, {
        ...
        _addCloseButton: function () {
            if (!this._closeButton) {
                ...
                this._closeButton.className = this.toThemeProperty('jqx-window-close-button jqx-icon-close-white');
        ...
        _addCollapseButton: function () {
            if (!this._collapseButton) {
                ...
                this._collapseButton.className = this.toThemeProperty('jqx-window-collapse-button jqx-icon-arrow-up-white');

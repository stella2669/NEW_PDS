...
<body>
	...
	<div class="popup_window drag w_700">
		...
		<div class="popup_content">
			...
			<div class="popup_body">
				<div class="title">
					<h2 class="title_2nd">캠페인 일정추가</h2>
				</div>
				<!-- table : start -->
				<div class="board_A0_L">
					<table aria-describedby="table_summary">
						<caption id="table_summary">캠페인 일정추가</caption>
						<colgroup>
	...
	<script type="text/javascript" src="<c:url value='/resources/js/cp/cm/CPCM05.js?timestamp=${nowDate}'/>"></script>
	<!-- wrap : end -->
</body>

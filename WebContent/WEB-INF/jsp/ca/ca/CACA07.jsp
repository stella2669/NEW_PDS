...
<body>
	...
	<div class="popup_window drag w_550">
		...
		<div class="popup_content">
			...
			<div class="popup_body">
				<div class="title">
					<h2 class="title_2nd">콜백 일괄종료</h2>
				</div>
				<!-- table : start -->
				<div class="board_A0_L">
					<table aria-describedby="table_summary">
						<caption id="table_summary">콜백 일괄종료</caption>
						<colgroup>
	...
	<script type="text/javascript" src="<c:url value='/resources/js/ca/ca/CACA07.js?timestamp=${nowDate}'/>"></script>
	<!-- wrap : end -->
</body>

...
<body>
			...
			<div class="popup_body inner_contents">
				<div class="w_100p" style="height:30px">
					<div class="title f_l" style="width:auto">
						<h2 class="title_2nd mt_5">[<b id="contatcNm"></b>] 컨택리스트에 대한 데이터소스 목록</h2>
					</div>
	...
	<script type="text/javascript" src="<c:url value='/resources/js/cu/co/CUCO04.js?timestamp=${nowDate}'/>"></script>
	<!-- wrap : end -->
</body>

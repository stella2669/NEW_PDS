...
( function ( $ ) {
    ...
    $.extend( $.jqx._jqxGrid.prototype, {
        ...
        _calculatevirtualheight: function () {
            ...
            if ( this.cardview ) {
                virtualheight -= visiblerecords * this.rowsheight;
            }
                    ...
                    if ( renderrow != null ) {
                        ...
                        if ( this.cardview ) {
                            ...
                            for ( var s = 0; s < this.cardsize; s++ ) {
                                if ( rowstorender != undefined ) {
                                    renderrow = rowstorender[ startindex + ( renderindex * this.cardsize ) + s ]
                                }
            ...
            if ( !isTouch ) {
                ...
                self.addHandler( $( document ), 'mouseup.selection' + self.element.id, function ( event ) {
                    if ( self._handlemouseupselection ) {
                        if ( event.shiftKey && $( event.target ).ischildof( self.host ) ) {

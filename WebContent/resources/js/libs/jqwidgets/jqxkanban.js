    ...
    $.extend( $.jqx._jqxKanban.prototype, {
        ...
        updateItem: function ( id, newContent ) {
            ...
            if ( !selectedItemSource ) {
                selectedItemSource = that._sourceKeys[ itemId ];
            }
        ...
        _addEventHandlers: function () {
            ...
            that.addHandler( $( '.jqx-kanban-item-color-status, .jqx-kanban-item-avatar, .jqx-kanban-item-text, .jqx-kanban-item-content, .jqx-kanban-item-keyword, .jqx-kanban-item-template-content' ), this._getEvent( "click" ), function () {
